...
class soft_to_angle(nn.Module):
    def __init__(self, mixture_size):
        ...
        phi_components = np.genfromtxt(base_dir+"data/mixture_model_pfam_"+str(mixture_size)+".txt")[:, 1]
        psi_components = np.genfromtxt(base_dir+"data/mixture_model_pfam_"+str(mixture_size)+".txt")[:, 2]
...
class RrnModel(openprotein.BaseModel):
    ...
    def _get_network_emissions(self, original_aa_string):
        print("_get_network_emissions - aa:", original_aa_string)
...
class q1(openprotein.BaseModel):
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class q3(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(q3, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class q11(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(q11, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class q22(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(q22, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class q12(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(q12, self).__init__(use_gpu, embedding_size)

        self.hidden_sizwwe = 3
        self.num_lstm_layers = 2
        self.mixture_size = 500
        self.bi_lstm = nn.LSTM(self.get_embedding_size(), self.hidden_size,
                            num_layers=self.num_lstm_layers, bidirectional=True, bias=True)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class w1(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(w1, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class w2(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(w2, self).__init__(use_gpu, embedding_size)
        ...
        self.bi_lstm = nn.LSTM(self.get_embedding_size(), self.hidden_size,
                            num_layers=self.num_lstm_layers, bidirectional=True, bias=True)
        self.hidden_to_labels = nn.Linear(self.hidden_size * 1, self.mixture_size, bias=True) # * 2 for bidirectional
        self.init_hidden(minibatch_size)
        self.softmax_to_angle = soft_to_angle(self.mixture_size)
        self.soft = nn.LogSoftmax(2)
        self.bn = nn.BatchNorm1d(self.mixture_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class ww1(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(ww1, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class ww2(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(ww2, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class qw1(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(qw1, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class LastS(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(LastS, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class ts31(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(ts31, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class ts32(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(ts32, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class ts33(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(ts33, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class ts34(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(ts34, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class ts35(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(ts35, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class ts36(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(ts36, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class c1(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(c1, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class c2(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(c2, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class DeModel(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(DeModel, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class DeModel2(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(DeModel2, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class DeModel3(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(DeModel3, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class DeModel4(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(DeModel4, self).__init__(use_gpu, embedding_size)
...
class DeM1(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(DeM1, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class MM(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(MM, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class MM2(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(MM2, self).__init__(use_gpu, embedding_size)
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class tt(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(tt, self).__init__(use_gpu, embedding_size)
...
class NewModel(openprotein.BaseModel):
    ...
    def _get_network_emissions(self, original_aa_string):
        ...
        backbone_atoms_padded, batch_sizes_backbone = get_backbone_positions_from_angular_prediction(output_angles, batch_sizes, self.use_gpu)
        return output_angles, backbone_atoms_padded, batch_sizes# Escribe tu modelo. Puedes sobre escribir esta plantilla (Python 3.8)
class NewModel2(openprotein.BaseModel):
    def __init__(self, embedding_size, minibatch_size, use_gpu=False):
        super(NewModel2, self).__init__(use_gpu, embedding_size)
