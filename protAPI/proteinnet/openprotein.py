...
class BaseModel(nn.Module):
    ...
    def evaluate_model(self, data_loader):
        ...
        data = {}
        data["pdb_data_pred"] = open(base_dir_root + "/protAPI/proteinnet/output/protein_test_pred.pdb", "r").read()
        data["pdb_data_true"] = open(base_dir_root + "/protAPI/proteinnet/output/protein_test.pdb", "r").read()
