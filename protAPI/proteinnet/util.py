...
def write_out(*args, end='\n'):
    ...
    if globals().get("experiment_id") is not None:
        with open(base_dir+"output/"+globals().get("experiment_id")+".txt", "a+") as output_file:
            output_file.write(output_string)
            output_file.flush()
    print(output_string, end="")

def write_model_to_disk(model):
    path = base_dir+"output/models/"+globals().get("experiment_id")+".model"
...
def write_result_summary(accuracy):
    ...
    with open(base_dir+"output/result_summary.txt", "a+") as output_file:
        output_file.write(output_string)
        output_file.flush()
    print(output_string, end="")
